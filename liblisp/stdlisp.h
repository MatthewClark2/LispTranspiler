 ...
 *
 * If no arguments are supplied, return 0. If non-numeric arguments are supplied, raise_err an error.
 */
 ...
 * are supplied, raise_err an error.
 */
 ...
 *
 * If no arguments are supplied, return 1. If non-numeric arguments are supplied, raise_err an error.
 */
 ...
 * arguments are supplied, raise_err an error.
 */
 ...
 *
 * Takes exactly two integer arguments. If anything else is provided, raise_err an error.
 */
